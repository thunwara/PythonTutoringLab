...
def main_screen():
    ...
    Label(text="Enter text for encryption and decryption", fg="white", font=("calbri", 13)).place(x=10,y=10)
    text1 = Text(font="Roboto 20", bg="white", relief=GROOVE, wrap=WORD, bd=0, fg= "black")
    text1.place(x=10,y=50,width=355, height=100)
    
    Label(text="Enter secret key for encryption and decryption", fg="white", font=("calibri", 13)).place(x=10,y=170)
    
    code = StringVar()
    Entry(textvariable=code, width=19, fg="white", bd=0,font=("arial", 25),show="*").place(x=10,y=200)
    
    Button(text="Encrypt", height=2, width= 23, bg="#ed3833", fg="black", bd=0, command=encrypt).place(x=10,y=250)
    Button(text="Decrypt", height=2, width= 23, bg="#00bd56", fg="black", bd=0, command=decrypt).place(x=233,y=250)
